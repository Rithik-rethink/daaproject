  ...
  <ReactBoostrap.Navbar.Collapse id="basic-navbar-nav">
    <ReactBoostrap.Nav className="mr-auto">
      ...
      <ReactBoostrap.NavDropdown title="More" id="basic-nav-dropdown">
        <ReactBoostrap.NavDropdown.Item href="/train">Check Train Routes</ReactBoostrap.NavDropdown.Item>
        <ReactBoostrap.NavDropdown.Item href="/price">Check Pricing</ReactBoostrap.NavDropdown.Item>
